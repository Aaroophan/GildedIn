...
{/* 
					...
					<div className="text-center">
						...
						>
						<h1 className="pb-4 font-oswald font-bold text-7xl sm:text-6xl lg:text-9xl scale-110 mb-4 lg:mb-8 bg-gradient-to-br from-[var(--foreground)] via-[var(--foreground)] to-[var(--foreground)] bg-clip-text text-transparent cursor-default ">
